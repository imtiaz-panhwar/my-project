...
function Navbar() {
  ...
  // Check if the current route is the Product Detail page
  const isProductDetailPage = pathname === "/allproducts/productDetail";

  return (
    <header className="bg-[#FFFFFF]">
      {/* Top Section */}
      <div className="max-w-[1440px] mx-auto h-[38px] bg-[#F5F5F5] flex items-center justify-between px-12">
        <div className="w-[24px] h-[24px]">
          <Image src="/vector.png" width={24} height={24} alt="Logo" />
        </div>
        <div>
          <p className="text-gray-700 font-serif text-[15px] font-semibold">
            <pre> Find a Store | Help | Join Us | Sign In </pre>
          </p>
        </div>
      </div>
